			     ...
			     const struct imx477_reg *regs, u32 len)
{
	...
	unsigned int i;
	int ret;
	printk(KERN_INFO "ov13850: imx477_write_regs\n");
...
{
	unsigned int i;
	printk(KERN_INFO "ov13850: imx477_get_format_code\n");
...
{
	printk(KERN_INFO "ov13850: imx477_set_default_format\n");
...
static int imx477_open(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh)
{
	...
	printk(KERN_INFO "ov13850: imx477_open\n");
...
{
	int ret = 0;
	printk(KERN_INFO "ov13850: imx477_set_frame_length\n");
...
static int imx477_set_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	u32 again = 0;
	u32 dgain = 0;
	printk(KERN_INFO "ov13850: imx477_set_ctrl %d %s=%d\n", ctrl->id, ctrl->name, ctrl->val);
	...
	case V4L2_CID_ANALOGUE_GAIN:
		...
		printk(KERN_INFO "ov13850: set again=%d dgain=%d\n", again, dgain);
		break;
...
{
	struct imx477 *imx477 = to_imx477(sd);
	printk(KERN_INFO "ov13850: imx477_enum_mbus_code\n");
...
{
	//struct imx477 *imx477 = to_imx477(sd);
	printk(KERN_INFO "ov13850: imx477_enum_frame_size\n");
				   ...
				   struct v4l2_subdev_frame_interval *fi)
{
	...
	const struct imx477_mode *mode = imx477->mode;
       printk(KERN_INFO "ov13850: imx477_g_frame_interval\n");
...
{
	printk(KERN_INFO "ov13850: imx477_update_image_pad_format\n");
...
{
	printk(KERN_INFO "ov13850: dummy imx477_update_metadata_pad_format\n");
...
{
	struct imx477 *imx477 = to_imx477(sd);
	printk(KERN_INFO "ov13850: imx477_get_fmt pad=%d\n", fmt->pad);
...
static void imx477_set_framing_limits(struct imx477 *imx477)
{
	...
	const struct imx477_mode *mode = imx477->mode;
	printk(KERN_INFO "ov13850: imx477_set_framing_limits\n");
				 ...
				 struct v4l2_subdev_format *fmt)
{
	...
	const struct imx477_mode *mode;
	struct imx477 *imx477 = to_imx477(sd);
	printk(KERN_INFO "ov13850: imx477_set_fmt\n");
				...
				struct v4l2_subdev_selection *sel)
{
	...
	printk(KERN_INFO "ov13850: imx477_get_selection\n");
...
{
	printk(KERN_INFO "ov13850: imx477_get_module_inf\n");
...
static long imx477_ioctl(struct v4l2_subdev *sd, unsigned int cmd, void *arg)
{
	...
	printk(KERN_INFO "ov13850: imx477_ioctl cmd=%d\n", cmd);
	...
	printk(KERN_INFO "ov13850: imx477_ioctl => %ld\n", ret);
...
static int imx477_start_streaming(struct imx477 *imx477)
{
	...
	printk(KERN_INFO "ov13850: imx477_start_streaming\n");
...
static void imx477_stop_streaming(struct imx477 *imx477)
{
	...
	printk(KERN_INFO "ov13850: imx477_stop_streaming\n");
...
static int imx477_s_stream(struct v4l2_subdev *sd, int enable)
{
	...
	printk(KERN_INFO "ov13850: imx477_s_stream, enable=%d\n", enable);
...
static int imx477_power_on(struct device *dev)
{
	...
	printk(KERN_INFO "ov13850: imx477_power_on");
...
static int imx477_power_off(struct device *dev)
{
	...
	printk(KERN_INFO "ov13850: imx477_power_off");
...
static int __maybe_unused imx477_suspend(struct device *dev)
{
	...
	printk(KERN_INFO "ov13850: imx477_suspend");
...
static int __maybe_unused imx477_resume(struct device *dev)
{
	...
	printk(KERN_INFO "ov13850: imx477_resume");
...
static int imx477_s_power(struct v4l2_subdev *sd, int on)
{
	...
	printk(KERN_INFO "ov13850: imx477_s_power, target=%d\n", on);
...
static const struct of_device_id imx477_dt_ids[] = {
	{ .compatible = "ovti,ov13850", .data = &imx477_compatible },
	{ /* sentinel */ }
};
